package team.stp.starrycore.core;
...
/**
 * 部分代码来自 NovaEng Core (GPL - 3.0)
 */
public class StarryPlugin implements IFMLLoadingPlugin {

    public static final Logger LOG = LogManager.getLogger("STARRY_CORE_PRE");
    public static final String LOG_PREFIX = "[STARRY_CORE_PRE]" + ' ';
    ...
    /**
     * @author Hikari_Nova, GBLodb
     * <br/>
     * <a href="https://github.com/GBLodb/PreventCrappyLauncher/blob/retro/src/main/java/gblodb/preventCrappyLauncher/PreventCrappyLauncher.java">Original Source Code (MPL 2.0)</a><br/>
     * <br/>
     * 你说得对，但是不得不写。<br/>
